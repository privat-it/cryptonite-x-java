...
public final class FILEPointer {
    ...
    public static Pointer toNative(FILEPointer value, ToNativeContext context) {
        return value != null ? value.pointer : null;
    }

    @FromNativeConverter.FromNative(nativeType = Pointer.class)
    public static FILEPointer fromNative(Pointer value, FromNativeContext context) {
        return value != null ? new FILEPointer(value) : null;
    }
}
